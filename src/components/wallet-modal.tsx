    ...
    return (
      <Dialog open={open}>
        <DialogContent className="window sm:max-w-[425px] rounded-none bg-[#FDCF79] border-0">
          ...
          0 ? (
          <>
          <label className="px-3 text-lg">Please connect a wallet to continue.</label>
                ...
                .map((wallet, i) => (
                  ...
                  >
                    <Image
                      ...
                      className="w-8 h-8"
                    />
                    <label className="text-lg font-medium">{wallet.adapter.name}</label>
                  </button>
                  </div>
                ))}
            </div>
            ...
            <div className="flex-col mx-auto py-4">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="mx-auto w-8 h-8"> <path d="M22 4v16h-6V4h6Zm-2 2h-2v12h2V6Zm-5 4v10H9V10h6Zm-2 8v-6h-2v6h2Zm-5-4v6H2v-6h6Zm-2 4v-2H4v2h2Z"/> </svg>
